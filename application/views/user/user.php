  ...
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="col-1 text-center p-2"><a href="<?= base_url('user/edit/' . $user->id) ?>" class="btn btn-warning"><i
              class="fas fa-pen"></i></a></td>
        <td class="col-1 text-center p-2"><a href="<?= base_url('user/hapus/' . $user->id) . "/" . $id_outlet?>" class="btn btn-danger"><i
